...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/noisy-limit-e61a
```

A live public deployment of this template is available at [https://noisy-limit-e61a.templates.workers.dev](https://noisy-limit-e61a.templates.workers.dev)
